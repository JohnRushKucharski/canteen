...
def is_all_quantities(*values: Any) -> bool:
    """
    Check if all provided values are instances of Quantity.
    ...
    *values : Any
    ...
    -------
    bool
        True if all values are Quantity instances, False otherwise.
    """
    return all(isinstance(v, Quantity) for v in values)

def is_all_numeric(*values: Any) -> bool:
    """
    Check if all provided values are numeric (int or float).
...
def is_all_volume_quantities(*values: Any) -> bool:
    """
    Check if all provided values are Quantity instances with volume units.
    ...
    *values : Any
    ...
    -------
    bool
        True if all values are Quantity instances with volume units, False otherwise.
    """
    return all(isinstance(v, Quantity) and v.unit.category == Category.VOLUME for v in values)

def is_same_unit_and_value_base(*values: Any) -> bool:
    """
    Check if all provided Quantity values have the same units and value bases.
    ...
    *values : Any
    ...
    -------
    bool
        True if all values are Quantity instances
        with the same units and value bases, False otherwise.
    """
