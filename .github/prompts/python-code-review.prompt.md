...
agent: "agent"
model: ['GPT-4o mini (copilot)', 'Claude Haiku 4.5 (copilot)', Claude Sonnet 4.5 (copilot)']
---

Read the [python-code-review skill](../skills/python-code-review/SKILL.md) in full, then execute it.
