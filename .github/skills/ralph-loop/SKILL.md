...
All issues returned by this query are AFK by definition — `ready-for-agent` means AFK (see `docs/agents/triage-labels.md`). No further type filtering is needed.
